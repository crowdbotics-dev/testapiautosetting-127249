...
## Project Structure
    ...
    ├── testapiautosetting_127249  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127249`
...
2. Clone this repo and `cd testapiautosetting_127249`
